...
from stable_baselines3.common.vec_env import VecNormalize # new

MODEL_DIR = Path("Output")
MODEL_DIR.mkdir(parents=True, exist_ok=True)  
# --- Configuration for Experiment --
MODEL_NAME = "../model/Par_100000_MLP/seed_1/mlp_model_ns128.zip"
EVAL_ENV_FILE = "test.json"

STATS_PATH = "../model/Par_100000_MLP/seed_1/vec_normalize_ns128.pkl"            # new
