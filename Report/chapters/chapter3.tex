...
Finally, section \ref{sec:hyp} summarizes the hyperparameter configuration used in this study.
%\begin{table}[h]
%\centering
%\begin{tabular}{ll}
%\hline
